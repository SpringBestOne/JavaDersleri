...
public class JavaMathClass {
    public static void main(String[] args) {
                ...
                double doubleSayi = Math.random()*100; // o ile 1 arasında sayı üretiyor
                System.out.println("doubleSayi = " + doubleSayi);
                /* int değerler üretme */
                int intSayi = (int) (Math.random()*100);  //Matematik classı double kullandığı için int. ı casting yaptık
