...
/*
 char[][] answers = {
         ...
         testSonuclari(answers,keys);

     }

    public static void testSonuclari(char[][] answers,char[] keys) {
        int ogrenciSayisi=0;
        int dogruSayisi=0;
        for (int i=0; i< answers.length; i++) {
            ...
            ogrenciSayisi++;
            System.out.println(ogrenciSayisi+ ". ogrencinin "+ dogruSayisi+" dogru cevabı vardır");
            dogruSayisi=0;
