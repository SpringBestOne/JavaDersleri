...
public class C05_MethodCreationReturn {
    ...
    public static String tarihAl() {
        ...
        System.out.println("Kacinci ay oldugunu tam sayi olarak yazin");
        int ay = scan.nextInt();

        if (ay <= 0 || ay > 12) {
            System.out.println("Ay no 1-12 arasinde olmalidir");
        } else if (ay < 10) {
            tarih = tarih + "0" + ay + "-";
        } else {
            tarih = tarih + ay + "-";
        ...
        if (gun <= 0 || gun > 31) {
            System.out.println("1-31 arasinda bir gun girin");
        } else if (gun < 10) {
            tarih = tarih + 0 + gun;
        } else {
            tarih = tarih + gun;
